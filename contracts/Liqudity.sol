...
contract LiquityExamples is IERC721Receiver {
    ...
    function onERC721Received(
        address operator,
        address,
        uint _tokenId, // Added missing underscore
        bytes calldata
    ) external override returns (bytes4) {
        _createDeposit(operator, _tokenId); // Fixed the function name typo
    ...
    function decreaseLiquidity(
        ...
        // Added missing return type for the function
