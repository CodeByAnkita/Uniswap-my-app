                    ...
                    <div className={Style.PoolAdd_box_price_left}>
                        ...
                        {openFee && (
                            <div className={Style.PoolAdd_box_price_left_list}>
                                {feepairs.map((el, i) => (
                                    <div
                                        className={Style.PoolAdd_box_price_left_fee_left_list_item}
                                        key={i + 1}
                                        onClick={() => setActive(i + 1)}
                                    >
                                        <div className={Style.PoolAdd_box_price_left_fee_left_list_item}>
                                            <p> {el.fee}</p>
                                            <p>
                                                {active === i + 1 ? (
                                                    <Image
                        ...
                        {/*//DEPOSIT AMOUNT */}
                        <div className={Style.PollAdd_box_deposit}>
                            <h4>Deposit Amount</h4>
                            <div className={Style.PollAdd_box_deposit_box}>
                                ...
                                <div className={Style.PollAdd_box_deposit_box}>
                                    <input type="text" placeholder="0" />
                                    <div className={Style.PoolAdd_box_deposit_box_input}></div>
                                    <p>
